...
export function ActionBanner({
  ...
  return (
    <div className="bg-brand-500/5 border border-brand-500/20 rounded-xl px-5 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
      ...
      <Link
        href={firstHref}
        className="inline-flex items-center gap-1.5 bg-brand-500 hover:bg-brand-600 text-white text-sm font-medium px-3.5 py-1.5 rounded-lg transition-colors self-start sm:self-auto"
      >
        Start reviewing
