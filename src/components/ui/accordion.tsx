...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-5 text-left text-base font-medium text-paper-900 transition-all hover:text-counsel-600 [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
